...
from autoqml_lib.search_space.util import (
    get_encoding_circuit,
    get_quantum_kernel,
    sample_encoding_circuit_configuration,
    sample_quantum_kernel_configuration,
)
from autoqml_lib.util.context import ConfigContext
from autoqml_lib.constants import TrialId

class QSVR(BaseEstimator, RegressorMixin, TunableMixin):
    ...
    def fit(self, X: InputData, y: TargetData):
        ...
        self.estimator = QSVR(quantum_kernel=quantum_kernel, C=self.C)
