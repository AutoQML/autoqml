...
# from autoqml_lib.automl import TabularStatistics
from autoqml_lib.backend import Backend
from autoqml_lib.constants import InputData, TargetData
from autoqml_lib.messages import AutoQMLFitCommand
from autoqml_lib.optimizer import evaluation, metric
...
class RayOptimizer(Optimizer):
    ...
    def optimize(
        ...
        def _trainable(
            ...
            trial_uuid = 'autoqml_lib_trial_' + str(uuid.uuid4())
