...
from autoqml_lib.constants import Budget, InputData, TargetData, TrialId
from autoqml_lib.optimizer.metric import Metric
...
def configuration_to_model(
    ...
    configuration = {
        k: v
        for k, v in configuration.items() if not k.startswith('autoqml_lib')
    }
